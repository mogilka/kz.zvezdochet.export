 ...
 * implementation.
 * @link http://www.java2s.com/Code/Java/Chart/JFreeChartGanttDemo1.htm
 * Принцип: для одной категории (ось Y) можно добавить сколько угодно серий (цвета),
 * но внутри серии отдельной категории может быть только один период
 */
public class Gantt extends ApplicationFrame {
	private static final long serialVersionUID = 2953305517956032309L;
