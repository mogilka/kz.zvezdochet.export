 ...
 * @link https://stackoverflow.com/questions/22108090/how-to-generate-a-table-of-contents-toc-with-itext
 */
public class Toc extends PdfPageEventHelper {
    ...
    public Toc() throws Exception {
        this.document = new Document(PageSize.A6);
        String filename = "/home/nataly/workspace/kz.zvezdochet.export/test/toc.pdf";
        ...
        for (int i = 1; i < count + 1; i++) {
            ...
            this.document.add(new VerticalPositionMark() {
                ...
                public void draw(final PdfContentByte canvas, final float llx, final float lly, final float urx, final float ury, final float y)
                {
                    ...
                    Toc.this.tocPlaceholder.put(title, createTemplate);
